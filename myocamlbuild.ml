(* OASIS_START *)
(* DO NOT EDIT (digest: 3806b77e5748ff1d326512a29b5a8c81) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("nes", ["src/lib"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_nes_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"])]);
          (["oasis_library_nes_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"])]);
          (["oasis_library_nes_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"])]);
          (["oasis_executable_nes_test_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"])]);
          (["oasis_executable_nes_test_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"])]);
          (["oasis_executable_nes_test_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"])])
       ];
     includes = [("src/tests", ["src/lib"])]
  }
  ;;
