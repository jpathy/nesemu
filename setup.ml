...
(* OASIS_START *)
(* DO NOT EDIT (digest: cc041f0e250f78fce401dcef373db9df) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "nes_test.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\"\215\252j\213>J\207\136F\1571\137\132\029\163";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
